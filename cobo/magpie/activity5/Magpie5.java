...
public class Magpie5
{
	...
	public String getResponse(String statement)
	{
		...
		if (isoIndexOf(statement,"no") >= 0)
		{
			response = "Why so negative?";
				...
				&& (isoIndexOf(statement, "because") < 0)) {
			response = respondToLike(statement);
		}
	...
	// 
	public String respondToLike(String input) {
		String str = "";

		int endIndex = input.indexOf("like")+4;
		...
		String subj = "they";
		if (isoIndexOf(input, "I") >= 0) {
			subj = "you"; 
		}
		else if (isoIndexOf(input, "you") >= 0) {
			return "I do like " + after;
		}	

		str += "What do " + subj + " like about " + after;
		return str;
	}
	...
	private String getRandomResponse()
	{
		...
		int whichResponse = (int) (r * NUMBER_OF_RESPONSES); // max is 4 (not including) and lowest is 0

		String[] responseBank = {"Interesting, tell me more.",
							"Hmmm.",
