...
public class BinSearch
{
  ...
  **/
                                  ...
                                  int lo, int hi )
  {
    ...
    // when low becomes greater than high, means doesn't exist
    if (lo > hi) {
        return tPos;
    }
    // target found
  ...
  public static void main ( String[] args )
  {
    ...
    // Testing out compareTo(o) method
    /*
    Comparable bigger = 5;
    Comparable smaller = 1;
    Comparable same = 5;

    System.out.println(bigger.compareTo(smaller)); // should return positive
    System.out.println(bigger.compareTo(same)); // should return 0
    System.out.println(smaller.compareTo(bigger)); // should return negative
    */
